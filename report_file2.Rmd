...
# PLS-DA Model
<br/><br/>
The subject **`r params$prova1PLSDA$Name`** under analysis is remarked by a \textcolor{orange}{orange triangle} in the PCA Scores Plot reported below:
<br/><br/>
...
<br/><br/>
The subject **`r params$prova1PLSDA$Name`** provides the following *likelihood ratio* values for the tested populations:
<br/><br/>

```{r, echo=FALSE}
dat_plsda_pred = params$prova1PLSDA
allComparisons = params$prova2PLSDA
